...
export default function MessageInput({
  ...
  return (
    <div className={styles.wrapper}>
      ...
      {quotedMessage && (
        <div className={styles.quoted_msg}>
          <QuotedMessage
      ...
      <div
        className={classNames(
          styles.form_block,
          quotedMessage && styles.quotedMessage
        )}
      >
        <form className={styles.form} onSubmit={(e) => handleSend(e)}>
          <input
            className={classNames(styles.msg_input)}
            ref={inputRef}
        ...
        {!replyInThread && (
          <div className={styles.send_btn} onClick={(e) => handleSend(e)}>
            <Image
              src="/icons/send.svg"
              alt="Send"
